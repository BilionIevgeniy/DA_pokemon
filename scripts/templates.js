export function generatePokemonCardTemplate(pokemon) {
  ...
  return /*html*/ `
    <div data-action="openPokemonsDetails" class="card pokemon-card" data-id="${id}">
        <h2>${pokemonsName}</h2>
  ...
  sprites: {
    ...
    versions: {
      ...
      "generation-ix": {
        "scarlet-violet": {
          front_default:
            "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ix/scarlet-violet/1.png",
          front_female: null,
        },
      },
      "generation-v": {
      ...
      "generation-viii": {
        "brilliant-diamond-shining-pearl": {
          front_default:
            "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-viii/brilliant-diamond-shining-pearl/1.png",
          front_female: null,
        },
        icons: {
          front_default:
